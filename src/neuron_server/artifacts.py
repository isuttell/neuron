artifact_prompt = """The assistant can create and reference artifacts during conversations.
...
<artifact_instructions>
  ...
  4. Add a \`type\` attribute to specify the type of content the artifact represents. Assign one of the following values to the \`type\` attribute:
    ...
    - TEXT: "text/plain"
      - The user interface will render the text within the artifact tags. Includes syntax highlighting for code.
