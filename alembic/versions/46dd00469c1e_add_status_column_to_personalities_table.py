"""Add status column to personalities table

Revision ID: 46dd00469c1e
Revises: 68ec8286f2b1
Create Date: 2025-07-25 19:52:26.613655
...
revision: str = '46dd00469c1e'
down_revision: Union[str, Sequence[str], None] = '68ec8286f2b1'
...
def upgrade() -> None:
    ...
    op.add_column('personalities', sa.Column('status', sa.String(), nullable=True))
...
def downgrade() -> None:
    """Downgrade schema."""
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_column('personalities', 'status')
