"""add personality message media items pivot table

Revision ID: 68ec8286f2b1
Revises: 59659c7ee4bb
Create Date: 2025-07-25 19:08:09.338443
...
revision: str = '68ec8286f2b1'
down_revision: Union[str, Sequence[str], None] = '59659c7ee4bb'
...
def upgrade() -> None:
    ...
    op.create_table('personality_message_media_items',
    sa.Column('id', sa.UUID(), nullable=False),
    sa.Column('personality_message_id', sa.UUID(), nullable=False),
    ...
    sa.ForeignKeyConstraint(['personality_message_id'], ['personality_messages.id'], ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('personality_message_id', 'media_item_id', name='unique_personality_message_media_item')
    )
    op.create_index(op.f('ix_personality_message_media_items_media_item_id'), 'personality_message_media_items', ['media_item_id'], unique=False)
    op.create_index(op.f('ix_personality_message_media_items_personality_message_id'), 'personality_message_media_items', ['personality_message_id'], unique=False)
...
def downgrade() -> None:
    ...
    op.drop_index(op.f('ix_personality_message_media_items_personality_message_id'), table_name='personality_message_media_items')
    op.drop_index(op.f('ix_personality_message_media_items_media_item_id'), table_name='personality_message_media_items')
    op.drop_table('personality_message_media_items')
    # ### end Alembic commands ###
