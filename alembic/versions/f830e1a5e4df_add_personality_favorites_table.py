"""Add personality_favorites table

Revision ID: f830e1a5e4df
Revises: 5f47b64a7a1f
Create Date: 2025-07-16 12:52:39.838015
...
revision: str = 'f830e1a5e4df'
down_revision: Union[str, Sequence[str], None] = '5f47b64a7a1f'
...
def upgrade() -> None:
    ...
    op.create_table('personality_favorites',
    ...
    sa.UniqueConstraint('personality_id', 'user_id', name='unique_personality_favorite')
    )
    op.create_index(op.f('ix_personality_favorites_personality_id'), 'personality_favorites', ['personality_id'], unique=False)
    op.create_index(op.f('ix_personality_favorites_user_id'), 'personality_favorites', ['user_id'], unique=False)
...
def downgrade() -> None:
    ...
    op.drop_index(op.f('ix_personality_favorites_user_id'), table_name='personality_favorites')
    op.drop_index(op.f('ix_personality_favorites_personality_id'), table_name='personality_favorites')
    op.drop_table('personality_favorites')
    # ### end Alembic commands ###
